            ...
            >
                ...
                <x-slot:content>
                    ...
                    <div class="nav-brands-container">
                        <a href="{{ route('shop.search.index', ['query' => 'afnan', 'brand' => 137]) }}">
                            <img src="/storage/theme/1/afnan-brand-logo.jpg" height="100" width="250" alt="" />
                         </a>
                        <a href="{{ route('shop.search.index', ['query' => 'armaf', 'brand' => 138]) }}">
                            <img src="/storage/theme/1/armaf-logo.jpg" height="100" width="250" alt="" />
                         </a>
                        <a href="{{ route('shop.search.index', ['query' => 'azzaro', 'brand' => 140]) }}">
                            <img src="/storage/theme/1/azzaro-logo.jpg" height="100" width="250" alt="" />
                         </a>
                        <a href="{{ route('shop.search.index', ['query' => 'davidoff', 'brand' => 141]) }}">
                            <img src="/storage/theme/1/davidoff.jpg" height="100" width="250" alt="" />
                         </a>
                        <a href="{{ route('shop.search.index', ['query' => 'emporio', 'brand' => 139]) }}">
                            <img src="/storage/theme/1/emporio-armani.jpg" height="100" width="250" alt="" />
                         </a>
                        <a href="{{ route('shop.search.index', ['query' => 'french', 'brand' => 142]) }}">
                            <img src="/storage/theme/1/french-avenue.jpg" height="100" width="250" alt="" />
                         </a>
                        <a href="{{ route('shop.search.index', ['query' => 'gucci', 'brand' => 144]) }}">
                            <img src="/storage/theme/1/gucci.jpg" height="100" width="250" alt="" />
                         </a>
                        <a href="{{ route('shop.search.index', ['query' => 'boss', 'brand' => 145]) }}">
                            <img src="/storage/theme/1/boss.jpg" height="100" width="250" alt="" />
                         </a>
                        <a href="{{ route('shop.search.index', ['query' => 'issey', 'brand' => 146]) }}">
                            <img src="/storage/theme/1/issey-miyake.jpg" height="100" width="250" alt="" />
                         </a>
                        <a href="{{ route('shop.search.index', ['query' => 'khadlaj', 'brand' => 147]) }}">
                            <img src="/storage/theme/1/khadlaj.jpg" height="100" width="250" alt="" />
                         </a>
                        <a href="{{ route('shop.search.index', ['query' => 'lattafa', 'brand' => 148]) }}">
                            <img src="/storage/theme/1/lattafa.jpg" height="100" width="250" alt="" />
                         </a>
                        <a href="{{ route('shop.search.index', ['query' => 'mancera', 'brand' => 149]) }}">
                            <img src="/storage/theme/1/mancera.jpg" height="100" width="250" alt="" />
                         </a>
                        <a href="{{ route('shop.search.index', ['query' => 'mont', 'brand' => 150]) }}">
                            <img src="/storage/theme/1/mont-blanc.jpg" height="100" width="250" alt="" />
                         </a>
                        <a href="{{ route('shop.search.index', ['query' => 'nautica', 'brand' => 151]) }}">
                            <img src="/storage/theme/1/nautica.jpg" height="100" width="250" alt="" />
                         </a>
                        <a href="{{ route('shop.search.index', ['query' => 'rasasi', 'brand' => 152]) }}">
                            <img src="/storage/theme/1/rasasi.jpg" height="100" width="250" alt="" />
                       </a> 
                        <a href="{{ route('shop.search.index', ['query' => 'ysl', 'brand' => 153]) }}">
                            <img src="/storage/theme/1/ysl.jpg" height="100" width="250" alt="" />
                          </a>
                        </div>
                    </div>
                </x-slot>
