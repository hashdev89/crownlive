            ...
            <template v-else>
                ...
                <x-shop::accordion class="overflow-hidden !border-b-0 max-md:rounded-lg max-md:!border-none max-md:!bg-gray-100">
                    ...
                    <x-slot:content class="mt-8 !p-0 max-md:mt-0 max-md:rounded-t-none max-md:border max-md:border-t-0 max-md:!p-4">
                        <div class="grid grid-cols-1 gap-4 max-sm:gap-2.5">
                            <div 
                            ...
                            >
                                ...
                                <label 
                                    :for="payment.method" 
                                    class="icon-radio-unselect peer-checked:icon-radio-select absolute top-5 cursor-pointer text-2xl text-navyBlue ltr:right-5 rtl:left-5 z-10"
                                >
                                </label>

                                <label 
                                    :for="payment.method" 
                                    class="block w-full cursor-pointer rounded-xl border border-zinc-200 p-5 transition-all hover:border-navyBlue hover:bg-gray-50 peer-checked:border-navyBlue peer-checked:bg-gray-50 max-md:flex max-md:gap-5 max-md:rounded-lg max-sm:gap-4 max-sm:px-4 max-sm:py-2.5"
                                >
